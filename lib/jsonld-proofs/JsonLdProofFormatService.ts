  ...
  implements ProofFormatService<JsonLdProofFormat>
{
  ...
  public async processProposal(
    ...
    const proposalJson = attachment.getDataAsJson<JsonLdFormatDataProofDetail>()
  ...
  public async acceptRequest(
    ...
    if (!verificationMethod) {
      throw new AriesFrameworkError('Missing verification method in proof data')
    }
  ...
  private async _getCredentialsForRequest(
    ...
    const credentials =
      await w3cCredentialService.getAllCredentialRecords(agentContext)
